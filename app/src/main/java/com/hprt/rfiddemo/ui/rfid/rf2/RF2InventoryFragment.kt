...
import com.hprt.rfiddemo.ui.rfid.rf1p.RF1PInventoryFragment
 ...
 * 盘点
 */
class RF2InventoryFragment : BaseFragment() {
    var binder: RFService.RFBinder?=null
    var all_nums = 0
    companion object {
        fun newInstance() = RF2InventoryFragment()
    }
    @Volatile
    ...
    private val periodTime: Long = 50
