package com.hprt.rfiddemo.ui.main.rf1p
...
import com.hprt.rfiddemo.ui.rfid.rf1p.RF1PRfidActivity
...
class RF1PMainActivity : BaseActivity() {
    ...
    override fun getContentView(): Int = R.layout.activity_main_rf1p

    override fun initView() {
        topbar.setTitle("RF1P功能展示")
        ...
        btn_rfid.setOnClickListener {
            startActivity(Intent(baseContext, RF1PRfidActivity::class.java))
        }
